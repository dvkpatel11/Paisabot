...
DEFAULTS = [
    ...
    ('risk', 'position_stop_loss', '-0.05', 'float', 'Long: exit if loss from entry < this'),
    ('risk', 'position_trailing_stop', '-0.08', 'float', 'Long: exit if decline from HWM < this'),
    ('risk', 'position_soft_warn', '-0.03', 'float', 'Long: reduce 50% if loss from entry < this'),
    ('risk', 'short_stop_loss', '-0.07', 'float', 'Short: exit if loss from entry < this'),
    ('risk', 'short_trailing_stop', '-0.10', 'float', 'Short: exit if decline from HWM < this'),
    ('risk', 'short_soft_warn', '-0.04', 'float', 'Short: reduce 50% if loss from entry < this'),
