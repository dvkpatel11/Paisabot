...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('initial_capital', sa.Numeric(14, 2), nullable=False, server_default='100000'),
        sa.Column('cash_balance', sa.Numeric(14, 2), nullable=False, server_default='100000'),
    ...
    op.create_table(
        ...
        # watchlist
        sa.Column('is_active', sa.Boolean(), server_default='true'),
        sa.Column('in_active_set', sa.Boolean(), server_default='false', nullable=False),
    ...
    # price_bars
    op.add_column('price_bars', sa.Column(
    ...
    op.add_column('factor_scores', sa.Column(
        'fundamentals_score', sa.Numeric(6, 4), nullable=True,
    ))
    op.add_column('factor_scores', sa.Column(
        'earnings_score', sa.Numeric(6, 4), nullable=True,
    ))
    op.add_column('factor_scores', sa.Column(
        'asset_class', sa.String(10), nullable=False, server_default='etf',
    ))
    ...
    op.create_unique_constraint(
        'uq_perf_date_asset_class', 'performance_metrics', ['date', 'asset_class'],
    )
    op.create_index('ix_performance_asset_class', 'performance_metrics', ['asset_class'])
